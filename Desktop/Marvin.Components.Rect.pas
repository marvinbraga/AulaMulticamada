...
type
  ...
  TRectangleMessage = class(TRectangle)
  private
...
constructor TRectangleMessage.Create(AOwner: TComponent; AEffect: TEffectRectangle);
begin
...
procedure TRectangleMessage.AdicionarComponente(AClassName: TComponentClass);
var
  LObjeto: TComponent;
begin
...
procedure TRectangleMessage.AdicionarEfeitoPapel;
begin
  { cria o efeito de papel }
  Self.AdicionarComponente(TPaperSketchEffect);
end;

procedure TRectangleMessage.AdicionarEfeitoSombra;
begin
  { cria sombra }
  Self.AdicionarComponente(TShadowEffect);
end;

procedure TRectangleMessage.Remover;
begin
...
procedure TRectangleMessage.InternalOnMouseDown(Sender: TObject; Button:
...
procedure TRectangleMessage.InternalOnMouseMove(Sender: TObject; Shift:
  TShiftState; X, Y: Single);
const
...
procedure TRectangleMessage.InternalOnMouseUp(Sender: TObject; Button:
  TMouseButton; Shift: TShiftState; X, Y: Single);
begin
  FEstaMovendo := False;
...
procedure TRectangleMessage.InternalOnDblClick(Sender: TObject);
begin
  Self.Remover;
end;
